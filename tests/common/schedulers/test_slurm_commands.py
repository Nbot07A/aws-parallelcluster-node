...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SlurmNode("queue1-st-c5xlarge-1", "nodeip", "nodehostname", "ALLOCATED+Not_RESPONDING+CLOUD+DRAIN", "queue1"), True),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SlurmNode("queue1-st-c5xlarge-1", "nodeip", "nodehostname", "ALLOCATED+Not_RESPONDING+CLOUD+DRAIN", "queue1"), False),
        (SlurmNode("queue1-st-c5xlarge-1", "nodeip", "nodehostname", "IDLE+Not_RESPONDING+CLOUD+DRAIN", "queue1"), True),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SlurmNode("queue1-st-c5xlarge-1", "nodeip", "nodehostname", "MIXED+POWERING_UP+CLOUD+DRAIN", "queue1"), False),
        (SlurmNode("queue1-st-c5xlarge-1", "nodeip", "nodehostname", "ALLOCATED+Not_RESPONDING+CLOUD+DOWN", "queue1"), False),
        (SlurmNode("queue1-st-c5xlarge-1", "nodeip", "nodehostname", "IDLE+CLOUD+POWERING_DOWN", "queue1"), False),
